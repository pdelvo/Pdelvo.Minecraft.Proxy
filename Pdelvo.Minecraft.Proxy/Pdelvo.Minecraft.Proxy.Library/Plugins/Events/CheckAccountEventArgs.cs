...
namespace Pdelvo.Minecraft.Proxy.Library.Plugins.Events
{
    ...
    public class CheckAccountEventArgs : PluginResultEventArgs<bool?>
    {
        ...
        /// </summary>
        /// <param name="startResult"> The starting value of the Result property. true means that the user is allowed to join, false means that the user is not allowed to join, null means that it is not sure if the client is allowed to join </param>
