...
namespace Pdelvo.Minecraft.Proxy.Library.Plugins.Events
{
    ...
    public class CancelEventArgs : EventArgs
    {
        ...
        /// <summary>
        ///   This message will throw a OperationCanceledException with the <see cref="CancelMessage">CancelMessage</see> if the <see
        ///    cref="Canceled">Canceled</see> flag is set to true
        /// </summary>
